...
class Ui_OpenSalesOrderDialog(object):
    def setupUi(self, OpenSalesOrderDialog):
        ...
        OpenSalesOrderDialog.resize(910, 470)
        sizePolicy = QSizePolicy(QSizePolicy.Fixed, QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(OpenSalesOrderDialog.sizePolicy().hasHeightForWidth())
        OpenSalesOrderDialog.setSizePolicy(sizePolicy)
        self.buttonBox = QDialogButtonBox(OpenSalesOrderDialog)
        self.buttonBox.setObjectName(u"buttonBox")
        self.buttonBox.setGeometry(QRect(20, 430, 871, 32))
        self.buttonBox.setOrientation(Qt.Horizontal)
        self.buttonBox.setStandardButtons(QDialogButtonBox.Ok)
        self.tableView = QTableView(OpenSalesOrderDialog)
        self.tableView.setObjectName(u"tableView")
        self.tableView.setGeometry(QRect(20, 50, 871, 361))
        self.label = QLabel(OpenSalesOrderDialog)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(0, 10, 911, 20))
        font = QFont()
